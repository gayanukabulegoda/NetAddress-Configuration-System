...
let tableData :Department[] = []

export const setTableData = (data: Department[]) => {
    tableData = data
}
                ...
                <table>
                    ...
                    {tableData.map(dep => (
                        <tr>
                            ...
                            <th>{dep.count}</th>
                            <th>{dep.blockSize}</th>
                            <th>{dep.defaultGateway}</th>
                            <th>{dep.networkAddress}</th>
                            <th>{dep.firstUsableIp}</th>
                            <th>{dep.lastUsableIp}</th>
                            <th>{dep.broadcastAddress}</th>
                            <th>{dep.subnetMask}</th>
                        </tr>
                    ))}
                    </tbody>
                </table>
